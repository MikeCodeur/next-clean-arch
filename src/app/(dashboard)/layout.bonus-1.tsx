        ...
        <div className="container px-4 sm:px-6 lg:px-8">
          <nav className="flex h-14 items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              {/* Dashboard - Accessible aux USER et plus */}
              ...
              {/* Bank - Accessible aux USER et plus */}
              {hasRequiredRole(user, RoleEnum.USER) && (
                <Link
                  className="flex items-center space-x-2 font-bold"
                  href="/bank"
              ...
              {/* Quick Add - Accessible aux MANAGER et plus */}
              {hasRequiredRole(user, RoleEnum.MANAGER) && (
                <Link
                  className="flex items-center space-x-2 font-bold"
                  href="/shop-admin/quick"
                >
                  <span>Quick Add</span>
                </Link>
              )}
              {/* Admin - Accessible aux ADMIN et plus */}
              {hasRequiredRole(user, RoleEnum.ADMIN) && (
                <Link
                  className="flex items-center space-x-2 font-bold"
                  href="/shop-admin/1"
                >
              ...
              {/* Redactor - Accessible aux REDACTOR et plus */}
              {hasRequiredRole(user, RoleEnum.REDACTOR) && (
                <Link
                  className="flex items-center space-x-2 font-bold"
                  href="/redactor"
                >
