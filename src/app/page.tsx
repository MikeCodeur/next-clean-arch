  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        ...
        <div className="fixed bottom-0 left-0 flex h-48 w-full items-center justify-center bg-linear-to-t from-white via-white lg:static lg:h-auto lg:w-auto lg:bg-none dark:from-black dark:via-black">
      ...
      <div className="before:bg-gradient-radial after:bg-gradient-conic relative z-[-1] flex flex-col items-center justify-center from-sky-200 from-white via-blue-200 to-transparent before:absolute before:inset-0 before:rounded-full before:blur-2xl before:content-[''] after:absolute after:inset-0 after:-z-20 after:blur-2xl after:content-[''] sm:before:w-[480px] sm:after:w-[240px] lg:before:h-[360px] dark:before:bg-linear-to-br dark:before:from-transparent dark:before:to-blue-700 dark:before:opacity-10 dark:after:from-sky-900 dark:after:via-[#0141ff] dark:after:opacity-40">
        <p className="z-10 mt-4 bg-linear-to-r from-indigo-600 to-fuchsia-500 bg-clip-text text-6xl text-transparent">
          Next Module
        </p>
        <Image
